package com.recipies.springrecipeapp.bootstrap;

import com.recipies.springrecipeapp.domain.*;
...
public class BootstrapRecipes implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public BootstrapRecipes(RecipeRepository recipeRepository, CategoryRepository categoryRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes(String... args) throws Exception {
        ...
        guacRecipe.setSource("Simply Recipes Website");
        ...
        tacosRecipe.setSource("Simply Recipes Website");
